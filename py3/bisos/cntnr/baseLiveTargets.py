...
####+BEGIN: bx:dblock:python:class :className "PalsBase_LiveTargets" :superClass "object" :comment "" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /PalsBase_LiveTargets/ object  [[elisp:(org-cycle)][| ]]
"""
class PalsBase_LiveTargets(object):
####+END:
    """
...
####+BEGIN: bx:dblock:python:class :className "PalsBase_HereParams" :superClass "object" :comment "" :classType "basic"
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Class-basic :: /PalsBase_HereParams/ object  [[elisp:(org-cycle)][| ]]
"""
class PalsBase_HereParams(object):
####+END:
    """
** Abstraction of the PalsBase for LiveTargets
"""
...
####+END:
        ...
        icm.cmndExampleMenuChapter('=HereParams=  *Facilities*')

        thisClass = "PalsBase_HereParams"

        bpoFpBases.examples_bpo_fpBases(bpoId, thisClass)

        repoLiveParams.examples_repoLiveParams_basic(bpoId=bpoId, className=thisClass)
...
####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "hereParamsSetup" :parsMand "bpoId" :parsOpt "" :argsMin "0" :argsMax "0" :asFunc "" :interactiveP ""
"""
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  ICM-Cmnd   :: /hereParamsSetup/ parsMand=bpoId parsOpt= argsMin=0 argsMax=0 asFunc= interactive=  [[elisp:(org-cycle)][| ]]
"""
class hereParamsSetup(icm.Cmnd):
    cmndParamsMandatory = [ 'bpoId', ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
...
####+END:
        ...
        if cmndArgs[0] == "here":
            invContext.run(
                icm.icmCmndLine(
                    cmndName="bpoFpParamsSet",
                    cmndPars={
                        'bpoId': bpoId,
                        'cls': "PalsBase_LiveTargets",
                        'palsLiveTargetMode': "here",
                    },
                    cmndArgs="",
                    verbosity='little',
                    comment='none',
            ...
            hereParamsInst = pattern.sameInstance(PalsBase_HereParams, bpoId)
            hereParamsBasePath = hereParamsInst.basePath_obtain()
